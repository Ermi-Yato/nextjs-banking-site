    ...
    <>
      ...
      <section>
        <div className="container">
          <div className="p-8 lg:py-20 bg-[#1C1C1C] rounded-2xl border border-[#262626] lg:max-w-5xl lg:mx-auto relative">

            <Image src={abstractImage} alt="image" className="absolute right-0 top-0 size-40 lg:size-64 w-auto h-auto" />
            <div>
            ...
            <form className="mt-10 lg:mt-16 flex flex-col lg:flex-row lg:justify-center gap-4 lg:gap-6">
              <div className="p-4 lg:p-5 rounded-full bg-[#191919] border border-[#262626] flex items-center">
                <input type="email" name="email" placeholder="Enter your Email" required className={`${inputClasses} w-full`} />
              </div>
            ...
            <div className="lg:max-w-xs lg:mx-auto mt-8">
