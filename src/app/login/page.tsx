            ...
            <div className="lg:max-w-2xl lg:mx-auto">
              ...
              <div className="lg:max-w-sm lg:mx-auto mt-8">
                <div className="flex flex-col gap-6 mt-6">
                  ...
                  <Link href="/signup" className="w-full flex">
                    <Button btnType="secondary" size="lg" dropShadow="yes" className="border border-[#333333] bg-[#262626] flex-1">Sign Up</Button>
                  </Link>
                </div>
                ...
                <div className="flex gap-5 mt-5 lg:mt-8 justify-center">
